                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cnpj_cpf" placeholder="CPF ou CNPJ">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="telefone_1" placeholder="99 9 9999-9999">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Telefone 2</label>
                                        <input type="text" class="form-control" name="telefone_2" placeholder="99 9 9999-9999">
                                    </div>
                                </div>
                            </div>
                            <br>
