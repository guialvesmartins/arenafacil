                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col" style="text-align:right">
                                ...
                                onclick=" . '"' . "pegar_dados($id, '$dia_semana')" . '"' . "><i class='fas fa-trash me-1'></i> Excluir </a>"; ?>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="_controle.php" method="post">
                            <br>
                            <p>Obs: Só é possivel realizar a alteração de horarios, não é permitido a alteração de dia da semana, caso necessário exclua o cadastro e realize-o novamente.</p>
                            <div class="row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="hora_inicio" value="<?php echo"$hora_inicio"?>"> 
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Hora de Fim</label>
                                        <input type="time" class="form-control" name="hora_fim" value="<?php echo"$hora_fim"?>"> 
                                    </div>
                                </div>
                            </div>
                            <br>
            ...
            <div class="modal-content">
                ...
                <form action="_controle.php" method="POST">
                    <div class="modal-body">
                        <p>Deseja realmente excluir o horário de funcionamento de </b><b id="desc">nome</b> ?</p>
                    </div>
