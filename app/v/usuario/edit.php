                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col" style="text-align:left">
                                <i class="fas fa-pencil-alt me-1"></i> Alteração - Cadastro de Usuários
                            </div>
                        ...
                        <form action="_controle.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sobrenome" value="<?php echo "$sobrenome" ?>" placeholder="Sobrenome">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>E-mail</label>
                                        <input type="email" class="form-control" name="email" value="<?php echo "$email" ?>" placeholder="mail@mail.com">
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Usuário</label>
                                        <input type="text" class="form-control" name="usuario" value="<?php echo "$usuario" ?>" placeholder="Usuário">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
