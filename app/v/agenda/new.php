                        ...
                        <form action="_controle.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="quadra_id" aria-label="Default select example">
                                            ...
                                            while ($linha = mysqli_fetch_assoc($dados)) {
                                                ...
                                                $id_quadra = $linha['id'];
                                                echo "<option value='$id_quadra'>$nome_quadra</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Valor</label>
                                        <input type="decimal" class="form-control" name="valor">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Usuário</label>
                                        <input type="text" value="<?php echo "$usuario_nome_logado"; ?>" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="form-group">
