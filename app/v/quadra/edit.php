...
<head>
    ...
    <title>ArenaFácil - Espaços de Jogo</title>
...
<body class="sb-nav-fixed">
    ...
    $nome           = $linha['nome'];
    $preco_hora     = $linha['preco_hora'];
    $preco_minuto   = $linha['preco_minuto'];
    ?>

    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Espaços de Jogo</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Início</li>
                    <li class="breadcrumb-item active">Cadastros</li>
                    <li class="breadcrumb-item active">Espaços de Jogo</li>
                </ol>
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col" style="text-align:left">
                                <i class="fas fa-plus me-1"></i> Inclusão - Cadastro de Espaços de Jogo
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nome" value="<?php echo "$nome" ?>" placeholder="Campo 1">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Preço da Hora</label>
                                        <input type="text" class="form-control" name="preco_hora" value="<?php echo "$preco_hora" ?>" placeholder="59,90">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Preço do Minuto</label>
                                        <input type="text" class="form-control" name="preco_minuto" value="<?php echo "$preco_minuto" ?>" placeholder="0,99">
                                    </div>
                                </div>
                            </div>
                            <br>
